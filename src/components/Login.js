                ...
                <div className="my-form1"> 
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="button-container">
                            <button type="submit" disabled={loading} className=' login_button btn'>Login</button>
                        </div>
                    </form>
                    <p className="continue">Or continue with</p>
                    <span style={{ display: "block" }}>
                        <BsGoogle alt="google" className="google_icon" onClick={googlelogin} />
                    </span>
                    <p style={{color:'black'}}>Create a new Account? <Link to='/signup'>Register</Link></p>
                </div>
            </div>
        </React.Fragment>
    );
